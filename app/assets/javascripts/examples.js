...
function showSearch(type, side) {
	...
	var toAdd = "<div id='" + type + "_search' height='300px' width='540px' style='display:inline; float:left; background-image: url(/assets/" + type + "_compare_blur.jpeg); height: 300px; width: 540px; margin-" + side + ": 10px'></div></li>";
...
function resort(type, side) {
	$("#" + type + "_container").empty();
	var toAdd = "<div height='300px' width='540px' onclick='showSearch(&quot;" + type + "&quot;, &quot;" + side + "&quot;)' style='display:inline; float:left;";
